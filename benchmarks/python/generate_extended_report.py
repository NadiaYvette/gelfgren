#!/usr/bin/env python3
"""
Generate Extended LaTeX Report

Adds new chapters to the comprehensive benchmark report documenting
the extended benchmark results comparing 6 methods across 20+ problems.
"""
...
def generate_chapter_11_helmholtz(output_file):
    """Generate Chapter 11: Helmholtz Benchmarks"""
    content = r"""
...
def generate_chapter_12_advection_diffusion(output_file):
    """Generate Chapter 12: Advection-Diffusion Benchmarks (Critical Findings)"""
    content = r"""
...
def generate_chapter_13_reaction_diffusion(output_file):
    """Generate Chapter 13: Reaction-Diffusion Benchmarks"""
    content = r"""
...
def generate_chapter_14_variable_coefficient(output_file):
    """Generate Chapter 14: Variable Coefficient Benchmarks"""
    content = r"""
...
def generate_chapter_15_cross_method_analysis(output_file):
    """Generate Chapter 15: Cross-Method Analysis"""
    content = r"""
...
def main():
    """Generate extended report chapters"""
    print("=" * 80)
    print("Generating Extended LaTeX Report")
    print("=" * 80)

    output_file = Path(__file__).parent.parent / 'reports' / 'latex' / 'extended_chapters.tex'

    print("\nGenerating extended chapters...")

    content = r"""\documentclass{report}
...
"""
    content += generate_chapter_11_helmholtz(output_file)
    content += generate_chapter_12_advection_diffusion(output_file)
    content += generate_chapter_13_reaction_diffusion(output_file)
    content += generate_chapter_14_variable_coefficient(output_file)
    content += generate_chapter_15_cross_method_analysis(output_file)
...
"""
    ...
    print(f"\nExtended chapters written to: {output_file}")
    print(f"  - Chapter 11: Helmholtz Benchmarks")
    print(f"  - Chapter 12: Advection-Diffusion (CRITICAL failures)")
    print(f"  - Chapter 13: Reaction-Diffusion (rationals excel)")
    print(f"  - Chapter 14: Variable Coefficient (CRITICAL failures)")
    print(f"  - Chapter 15: Cross-Method Analysis & Recommendations")
