...
- **Rational ([2/2] Padé per interval)**: DOF = $6n$

Rational approximants use more DOF per interval but may achieve target accuracy with fewer intervals (coarser mesh).
